...
1. Python
   ...
   <img src="screenshot/1_python.png" alt="Python 초성 게임" width="500px" />
2. Pandas
   ...
   <img src="screenshot/2_pandas.png" alt="Python 초성 게임" width="500px" />
3. Public Data
   ...
   <img src="screenshot/3_public_data.png" alt="Public Data 공유 킥보드 시장 분석" width="500px" />
4. Web Scraping
   ...
   <img src="screenshot/4_web_scraping.png" alt="Web Scraping 중고나라 스크래핑" width="500px" />
5. R Programing
...
8. Deep Learning
   ...
   <img src="screenshot/8_deep_learning.png" alt="Deep Learning Image Upscaling" width="500px" />